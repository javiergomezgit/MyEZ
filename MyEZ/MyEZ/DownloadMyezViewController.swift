...
class DownloadMyezViewController: UIViewController {
    ...
    /*  func sendEmailHotmail() {
     
     let smtpSession = MCOSMTPSession()
     smtpSession.hostname = "smtp.live.com"
     smtpSession.username = "javier.go.go@hotmail.com"
     smtpSession.password = "newjavier.15"
     ...
     let builder = MCOMessageBuilder()
     builder.header.to = [MCOAddress(displayName: "Charles", mailbox: "javier@ezinflatables.com")]
     builder.header.from = MCOAddress(displayName: "Xavier", mailbox: "javier.go.go@hotmail.com")
     builder.header.subject = "Test Email"
     builder.htmlBody="<p>Thank you for watching</p> <p>You're so awesome!</p> <br /> <a href = 'https://view.publitas.com/47750/451346/pdfs/26eed7a804397175d1b4a020c39eedd6e7370273.pdf'>Download clicking here "
